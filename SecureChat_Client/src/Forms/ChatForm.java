...
public class ChatForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(380, 40, 118, 102);
        ...
        jScrollPane2.setBounds(380, 210, 118, 139);

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel1.setText("Chat with");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(380, 20, 110, 14);

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel2.setText("Online Users");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(380, 190, 110, 14);
        ...
        sendBtn.setBounds(250, 320, 120, 30);
        ...
        addBtn.setBounds(380, 360, 118, 31);
        ...
        jScrollPane4.setBounds(10, 270, 360, 40);
        ...
        removBtn.setBounds(380, 150, 118, 23);
        ...
        chatText.setBounds(10, 24, 360, 240);

        sendFile.setText("Attach File");
        ...
        sendFile.setBounds(250, 360, 118, 33);

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/b10.jpg"))); // NOI18N
        jLabel3.setOpaque(true);
        getContentPane().add(jLabel3);
        jLabel3.setBounds(-30, -360, 770, 1000);
